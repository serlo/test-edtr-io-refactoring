...
export function useTextConfig(config) {
    const { placeholder = 'Write something or add elements with \u2295.', i18n = {}, theme = {}, blockquote, noLinebreaks, } = config;
