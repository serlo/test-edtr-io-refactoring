...
export function HoveringToolbar(props) {
    ...
    return (<>
      <InlineOverlay config={config} initialPosition={initialPosition} hidden={!selection ||
            !focused ||
            isSelectionCollapsed ||
            SlateEditor.string(editor, selection) === ''}>
        <HoveringToolbarControls theme={config.theme} controls={controls} editor={editor}/>
      </InlineOverlay>
      <TimeoutBottomToolbarWrapper isTouch={isTouchDevice()} visible={!!isSelectionCollapsed && isBottomToolbarActive}>
        {isBottomToolbarActive && (<HoveringToolbarControls theme={config.theme} controls={controls} editor={editor}/>)}
