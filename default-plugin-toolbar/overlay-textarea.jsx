...
const OverlayTextareaInner = styled.textarea(({ config }) => {
    return {
...
export function createOverlayTextarea(config) {
    return function OverlayTextarea({ label, ...props }) {
        return (<OverlayTextareaLabel>
