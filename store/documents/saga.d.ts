...
export declare function handleRecursiveInserts(scope: string, act: (helpers: StoreDeserializeHelpers) => unknown, initialDocuments?: {
    ...
    plugin: string;
    state?: unknown;
}[]): Generator<import("redux-saga/effects").SelectEffect, [ReversibleAction<import("../actions").InternalAction, import("../actions").InternalAction>[], unknown], (import("../../internal__plugin").EditorPlugin<import("../../internal__plugin-state").StateType<any, any, any>, {}> & import("../storetypes").DocumentState) | null>;
