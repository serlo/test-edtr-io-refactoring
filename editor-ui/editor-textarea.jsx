...
/** @public */
export const EditorTextarea = React.forwardRef(function EditorTextarea({ onMoveOutLeft, onMoveOutRight, ...props }, ref) {
    return (<StyledIgnoreKeys except={['up', 'down']}>
      <TextareaAutosize {...props} style={{
            width: '100%',
            margin: 'auto',
            padding: '10px',
            resize: 'none',
