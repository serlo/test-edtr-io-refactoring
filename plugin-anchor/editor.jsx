...
export const AnchorEditor = (props) => {
    ...
    return (<>
      ...
      {focused ? (<EditorInput label={i18n.label} placeholder={i18n.placeholder} value={state.value} onChange={(e) => {
                state.set(e.target.value);
            }} ref={props.autofocusRef}/>) : null}
    </>);
};
